...
public class GameSession {
    ...
    @Column(name = "warnsdorff_time_ms")
    private Integer warnsdorffTimeMs;

    @Column(name = "backtracking_time_ms")
    private Integer backtrackingTimeMs;
    ...
    // ========== ALGORITHM TIME GETTERS AND SETTERS ==========

    public Integer getWarnsdorffTimeMs() {
        return warnsdorffTimeMs;
    }

    public void setWarnsdorffTimeMs(Integer warnsdorffTimeMs) {
        this.warnsdorffTimeMs = warnsdorffTimeMs;
    }

    public Integer getBacktrackingTimeMs() {
        return backtrackingTimeMs;
    }

    public void setBacktrackingTimeMs(Integer backtrackingTimeMs) {
        this.backtrackingTimeMs = backtrackingTimeMs;
    }
}